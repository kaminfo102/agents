...
export function EditRepresentativeDialog({ representative, trigger }: EditRepresentativeDialogProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      educationCenter: representative.educationCenter,
    },
  });
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      const updatedRepresentative = await response.json();
      ...
      eventEmitter.emit(EVENTS.REPRESENTATIVE_UPDATED, updatedRepresentative);
      router.refresh();
    } catch (error) {
      toast({
        variant: "destructive",
